...
class ScorecardGenerator(object):
    ...
    def __init__(self, db, agency, debug=False):
        ...
        self.__all_domains = []
        self.__base_domains = []
        # second-level/base-domains
        self.__eligible_domains_count = 0
        self.__eligible_subdomains_count = 0
        # responsive base+subs
        self.__all_eligible_domains_count = 0
        ...
        # added
        self.__domain_enforces_https_count = float(0)
    ...
    def __score_domain(self, domain):
        ...
        if domain["live"] == "True":
            ...
            if domain["domain_supports_https"] == "True":
                ...
                # print("valid no "+ score['domain'])  #debug
            ...
            # if this domain has any subdomains
        ...
        # if domain['live'] == "False", ddd to ineligible domain list if host not live
        else:
            # only include base domains in the ineligible count; otherwise lots
            # of non-existent subs will show in the report
            if domain["domain"] == domain["base_domain"]:
    ...
    def __populate_scorecard_doc(self):
        ...
        # base + subs
        print (self.__domain_count)
        # base
        print (self.__base_domain_count)
        # responsive base
        print (self.__eligible_domains_count)
        # subs
        print (self.__subdomain_count)
        # responsive subs
        print (self.__eligible_subdomains_count)
    ...
    def __figure_overview(self):
        ...
        # dhs blue
        p1 = plt.bar(ind, Perct, width, color="#0058A1", edgecolor="none")
    ...
    def __generate_mustache_json(self, filename):
        ...
        # added
        result["domain_supports_https_count"] = int(self.__domain_supports_https_count)
